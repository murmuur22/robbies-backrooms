...
execute if score RNG RNG_Variable matches 11..20 run setblock ~ ~ ~ refurbished_furniture:computer[facing=west]
execute if score RNG RNG_Variable matches 21..30 run setblock ~ ~ ~ refurbished_furniture:television[facing=west]
