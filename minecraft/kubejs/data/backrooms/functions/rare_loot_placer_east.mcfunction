...
execute if score RNG RNG_Variable matches 2 run setblock ~ ~ ~ refurbished_furniture:light_toaster[facing=west]
...
execute if score RNG RNG_Variable matches 5 run setblock ~ ~ ~ refurbished_furniture:light_stove[facing=west]
execute if score RNG RNG_Variable matches 6 run setblock ~ ~ ~ refurbished_furniture:light_microwave[facing=west]
execute if score RNG RNG_Variable matches 7 run setblock ~ ~ ~ refurbished_furniture:red_cooler[facing=west]
execute if score RNG RNG_Variable matches 8 run setblock ~ ~ ~ refurbished_furniture:light_electricity_generator[facing=west]
execute if score RNG RNG_Variable matches 9 run setblock ~ ~ ~ refurbished_furniture:oak_drawer[facing=west]
